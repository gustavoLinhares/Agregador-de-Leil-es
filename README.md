...
Coleta: 
 - Spiders em sites de leiloeiros
 - Cruzar o dado do leilão com a Tabela FIPE (para carros) ou valor de m² da região (para imóveis) automaticamente. Calcular a margem bruta teórica.

O Produto: 
 - Uma página filtrável, com as melhores opções levando em consideração a localização do cliente.
